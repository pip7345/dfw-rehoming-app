...
// Import from $Enums namespace in Prisma v7
import type { $Enums } from '@prisma/client';

type PetStatus = $Enums.PetStatus;
...
export const PetsRepo = {
  ...
  async search(params: SearchPetsParams) {
    ...
    if (query) {
      ...
      const ageMatches: PetAge[] = [];
      const sizeMatches: PetSize[] = [];
      const typeMatches: PetType[] = [];
  ...
  update(id: string, data: UpdatePetData) {
